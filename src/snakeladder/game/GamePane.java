...
public class GamePane extends GameGrid
{
  ...
  // reverse all connection when toggle button pressed
  ...
  public Puppet getAnotherPuppet(){
  ...
  // get connection on specific cell
  Connection getConnectionOn(int cellIndex)
  {
    for (Connection con : connections)
      if (con.locStart.equals(cellIndex))
        return con;
    return null;
  }
  ...
  public Puppet getPuppet() {return puppets.get(currentPuppetIndex);}
